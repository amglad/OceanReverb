...
void BiquadLPF::processBuffer(float * samples, const int numSamples, const int channel)
{
    updateCoefficients();
...
float BiquadLPF::processSample(float x, int channel)
{
...
void BiquadLPF::setFs(float sampleRate)
{
    this->Fs = sampleRate;
    updateCoefficients(); // Need to update if Fs changes
};

float BiquadLPF::getFs()
{
    return Fs;
};

void BiquadLPF::setFreq(float freq)
{
...
float BiquadLPF::getFreq()
{
    return freq;
};

void BiquadLPF::setQ(float Q)
{
    this->Q = Q;
...
float BiquadLPF::getQ()
{
    return Q;
};

void BiquadLPF::setAmpdB(float ampdB)
{
    this->ampdB = ampdB;
...
float BiquadLPF::getAmpdB()
{
    return ampdB;
};

void BiquadLPF::updateCoefficients()
{
    switch (filterType)
    {
        case LPF:
